...
def get_onmt_transformer_seq2seq_model(vocab_x, vocab_y, transformer_config):
    if transformer_config == '6layer':
    ...
    elif transformer_config == '2layer':
        emb_size = 256
        dropout_rate=0.1
        d_model = 256
        n_head = 4
        ...
        n_layers = 2
        max_relative_positions = 0
    elif transformer_config == '3layer_new':
        emb_size = 256
        dropout_rate=0.1
        d_model = 256
        n_head = 4
    ...
    elif transformer_config == '6layer_new':
        emb_size=512
        dropout_rate = 0.1
        d_model = 512
        n_head = 8
        ...
        n_layers = 6
        max_relative_positions = 20
    elif transformer_config == '12layer_new':
        emb_size =1024
        dropout_rate = 0.1
        d_model = 1024
        n_head = 16
